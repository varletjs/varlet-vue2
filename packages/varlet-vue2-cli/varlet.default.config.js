module.exports = {
  ...
  pc: {
    ...
    indexPage: {
      description: {
        'zh-CN':
          'Varlet-Vue2 是一个基于 Vue2 开发的 Material 风格移动端组件库，全面拥抱 Vue2 生态，由社区团队维护。支持 Typescript、按需引入、暗黑模式、主题定制、国际化，并提供 VSCode 插件保障良好的开发体验',
        'en-US':
          'Varlet-Vue2 is a Material design mobile component library developed based on Vue2, developed and maintained by partners in the community. Support Typescript, import on demand, dark mode, theme customization, internationalization, and provide VSCode plugin to ensure a good development experience',
      },
      started: {
        'zh-CN': '起步',
        'en-US': 'GET STARTED',
      ...
      contributors: {
        ...
        link: 'https://github.com/varletjs/varlet-vue2/graphs/contributors',
        image: 'https://contrib.rocks/image?repo=varletjs/varlet-vue2',
      },
      license: {
      ...
      copyright: {
        'zh-CN': 'Copyright © 2020 varletjs 组织成员以及 varlet-vue2 的贡献者们',
        'en-US': 'Copyright © 2020 varletjs member and varlet-vue2 contributors.',
      },
    },
    title: {
