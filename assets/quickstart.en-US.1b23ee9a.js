...
`)])])])],1)])},p=[function(){var s=this,r=s.$createElement,t=s._self._c||r;return t("div",{staticClass:"card"},[t("h3",[s._v("Intro")]),t("p",[s._v("Here are the most basic ways to access component libraries in common development patterns.")])])},function(){var s=this,r=s.$createElement,t=s._self._c||r;return t("p",[t("code",{pre:!0},[s._v("varlet.js")]),s._v(" contain all the styles and logic of the component library, and you can import them.")])}];const l={components:{}},a={};var v=e(l,n,p,!1,_,null,null,null);function _(s){for(let r in a)this[r]=a[r]}var i=function(){return v.exports}();export{i as default};
